...
<head>
    ...
    <title>Panel Administrativo | P&B SHOP</title>
    ...
    <link href="{{asset('libs/sbadmin/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
    <link
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="text-decoration-none fw-bold fs-5 text-center text-light d-flex align-items-center justify-content-center" href="#">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link" href="{{route('images.index')}}">
                    ...
                    <span>Imágen de portada</span></a>
            </li> --}}
            {{-- <li class="nav-item">
                <a class="nav-link" href="">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Imágen de catalogos</span></a>
            </li> --}}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">¿Listo para cerrar la sesión?</h5>
